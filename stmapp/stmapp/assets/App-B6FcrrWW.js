 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ww=1e3,Tw=2,Aw=4*60*60*1e3,vw=.5;function Sw(n,e=ww,t=Tw){const r=e*Math.pow(t,n),s=Math.round(vw*r*(Math.random()-.5)*2);return Math.min(Aw,r+s)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ST="firebase-heartbeat-database",bT=1,Ci="firebase-heartbeat-store";let $c=null;function vm(){return $c||($c=Gw(ST,bT,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(Ci)}catch{}}}}).catch(n=>{throw Rn.create("idb-open",{originalErrorMessage:n.message})})),$c}async function RT(n){try{const t=(await vm()).transaction(Ci),r=await t.objectStore(Ci).get(Sm(n));return await t.done,r}catch(e){if(e instanceof vt)zt.warn(e.message);else{const t=Rn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});zt.warn(t.message)}}}async function zd(n,e){try{const r=(await vm()).transaction(Ci,"readwrite");await r.objectStore(Ci).put(e,Sm(n)),await r.done}catch(t){if(t instanceof vt)zt.warn(t.message);else{const r=Rn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});zt.warn(r.message)}}}function Sm(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function VT(n){Lt(new Tt("platform-logger",e=>new zw(e),"PRIVATE")),Lt(new Tt("heartbeat",e=>new xT(e),"PRIVATE")),dt(hu,qd,n),dt(hu,qd,"esm2020"),dt("fire-js","")}VT("");function bm(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}const OT=bm,Rm=new vs("auth","Firebase",bm());/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function vA(n,e){return Wi(n,"POST","/v1/accounts:signInWithEmailLink",Zt(n,e))}async function SA(n,e){return Wi(n,"POST","/v1/accounts:signInWithEmailLink",Zt(n,e))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ss{constructor(){this.providerId=Ss.PROVIDER_ID}static credential(e,t){return xi._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const r=rl.parseLink(t);return K(r,"argument-error"),xi._fromEmailAndCode(e,r.code,r.tenantId)}}Ss.PROVIDER_ID="password";Ss.EMAIL_PASSWORD_SIGN_IN_METHOD="password";Ss.EMAIL_LINK_SIGN_IN_METHOD="emailLink";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ev=new Hi(5e3,15e3),wv="__/auth/iframe",Tv="emulator/auth/iframe",Av={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},vv=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Sv(n){const e=n.config;K(e.authDomain,n,"auth-domain-config-required");const t=e.emulator?Zu(e,Tv):`https://${n.config.authDomain}/${wv}`,r={apiKey:e.apiKey,appName:n.name,v:vr},s=vv.get(n.config.apiHost);s&&(r.eid=s);const i=n._getFrameworks();return i.length&&(r.fw=i.join(",")),`${t}?${$i(r).slice(1)}`}async function bv(n){const e=await Iv(n),t=Vt().gapi;return K(t,n,"internal-error"),e.open({where:document.body,url:Sv(n),messageHandlersFilter:t.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:Av,dontclear:!0},r=>new Promise(async(s,i)=>{await r.restyle({setHideOnLeave:!1});const o=kt(n,"network-request-failed"),c=Vt().setTimeout(()=>{i(o)},Ev.get());function u(){Vt().clearTimeout(c),s(r)}r.ping(u).then(u,()=>{i(o)})}))}/**
 * @license
 * Copyright 2020 Google LLC.
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Kc="webStorageSupport";class Fv{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=ng,this._completeRedirectFn=cv,this._overrideRedirectResult=iv}async _openPopup(e,t,r,s){var o;Kt((o=this.eventManagers[e._key()])==null?void 0:o.manager,"_initialize() not called before _openPopup()");const i=await lf(e,t,r,fu(),s);return kv(e,i,sl())}async _openRedirect(e,t,r,s){await this._originValidation(e);const i=await lf(e,t,r,fu(),s);return jA(i),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:s,promise:i}=this.eventManagers[t];return s?Promise.resolve(s):(Kt(i,"If manager is not set, promise should be"),i)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await bv(e),r=new lv(e);return t.register("authEvent",s=>(K(s==null?void 0:s.authEvent,e,"invalid-auth-event"),{status:r.onEvent(s.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Kc,{type:Kc},s=>{var o;const i=(o=s==null?void 0:s[0])==null?void 0:o[Kc];i!==void 0&&t(!!i),At(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=mv(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Gm()||Mm()||tl()}}const Uv=Fv;var hf="@firebase/auth",df="1.13.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const lg="https://content-firebaseappcheck.googleapis.com/v1",Xv="exchangeRecaptchaV3Token",Zv="exchangeDebugToken",pf={RETRIAL_MIN_WAIT:30*1e3,RETRIAL_MAX_WAIT:16*60*1e3},eS=24*60*60*1e3;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tS{constructor(e,t,r,s,i){if(this.operation=e,this.retryPolicy=t,this.getWaitDuration=r,this.lowerBound=s,this.upperBound=i,this.pending=null,this.nextErrorWaitInterval=s,s>i)throw new Error("Proactive refresh lower bound greater than upper bound!")}start(){this.nextErrorWaitInterval=this.lowerBound,this.process(!0).catch(()=>{})}stop(){this.pending&&(this.pending.reject("cancelled"),this.pending=null)}isRunning(){return!!this.pending}async process(e){this.stop();try{this.pending=new Pi,this.pending.promise.catch(t=>{}),await nS(this.getNextRun(e)),this.pending.resolve(),await this.pending.promise,this.pending=new Pi,this.pending.promise.catch(t=>{}),await this.operation(),this.pending.resolve(),await this.pending.promise,this.process(!0).catch(()=>{})}catch(t){this.retryPolicy(t)?this.process(!1).catch(()=>{}):this.stop()}}getNextRun(e){if(e)return this.nextErrorWaitInterval=this.lowerBound,this.getWaitDuration();{const t=this.nextErrorWaitInterval;return this.nextErrorWaitInterval*=2,this.nextErrorWaitInterval>this.upperBound&&(this.nextErrorWaitInterval=this.upperBound),t}}}function nS(n){return new Promise(e=>{setTimeout(e,n)})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rS={"already-initialized":"You have already called initializeAppCheck() for FirebaseApp {$appName} with different options. To avoid this error, call initializeAppCheck() with the same options as when it was originally called. This will return the already initialized instance.","use-before-activation":"App Check is being used before initializeAppCheck() is called for FirebaseApp {$appName}. Call initializeAppCheck() before instantiating other Firebase services.","fetch-network-error":"Fetch failed to connect to a network. Check Internet connection. Original error: {$originalErrorMessage}.","fetch-parse-error":"Fetch client could not parse response. Original error: {$originalErrorMessage}.","fetch-status-error":"Fetch server returned an HTTP error status. HTTP status: {$httpStatus}.","storage-open":"Error thrown when opening storage. Original error: {$originalErrorMessage}.","storage-get":"Error thrown when reading from storage. Original error: {$originalErrorMessage}.","storage-set":"Error thrown when writing to storage. Original error: {$originalErrorMessage}.","recaptcha-error":"ReCAPTCHA error.","initial-throttle":"{$httpStatus} error. Attempts allowed again after {$time}",throttled:"Requests throttled due to previous {$httpStatus} error. Attempts allowed again after {$time}"},tt=new vs("appCheck","AppCheck",rS);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function hS(n){if(La()){let e;try{e=await aS(n)}catch(t){An.warn(`Failed to read token from IndexedDB. Error: ${t}`)}return e}}function Hc(n,e){return La()?cS(n,e).catch(t=>{An.warn(`Failed to write token to IndexedDB. Error: ${t}`)}):Promise.resolve()}async function dS(){let n;try{n=await lS()}catch{}if(n)return n;{const e=crypto.randomUUID();return uS(e).catch(t=>An.warn(`Failed to persist debug token to IndexedDB. Error: ${t}`)),e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function cl(){return Ga().enabled}async function ul(){const n=Ga();if(n.enabled&&n.token)return n.token.promise;throw Error(`
        ...
        `)}function fS(){const n=Qu(),e=Ga();if(e.initialized=!0,typeof n.FIREBASE_APPCHECK_DEBUG_TOKEN!="string"&&n.FIREBASE_APPCHECK_DEBUG_TOKEN!==!0)return;e.enabled=!0;const t=new Pi;e.token=t,typeof n.FIREBASE_APPCHECK_DEBUG_TOKEN=="string"?t.resolve(n.FIREBASE_APPCHECK_DEBUG_TOKEN):t.resolve(dS())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class yS{constructor(e,t){this.app=e,this.heartbeatServiceProvider=t}_delete(){const{tokenObservers:e}=xe(this.app);for(const t of e)Ig(this.app,t.next);return Promise.resolve()}}function IS(n,e){return new yS(n,e)}function ES(n){return{getToken:e=>da(n,e),getLimitedUseToken:()=>gS(n),addTokenListener:e=>yg(n,"INTERNAL",e),removeTokenListener:e=>Ig(n.app,e)}}const wS="@firebase/app-check",TS="0.11.2";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const AS="https://www.google.com/recaptcha/api.js";function vS(n,e){const t=new Pi,r=xe(n);r.reCAPTCHAState={initialized:t};const s=SS(n),i=mf(!1);return i?_f(n,e,i,s,t):PS(()=>{const o=mf(!1);if(!o)throw new Error("no recaptcha");_f(n,e,o,s,t)}),t.promise}function _f(n,e,t,r,s){t.ready(()=>{RS(n,e,t,r),s.resolve(t)})}function SS(n){const e=`fire_app_check_${n.name}`,t=document.createElement("div");return t.id=e,t.style.display="none",document.body.appendChild(t),e}async function bS(n){ol(n);const t=await xe(n).reCAPTCHAState.initialized.promise;return new Promise((r,s)=>{const i=xe(n).reCAPTCHAState;t.ready(()=>{r(t.execute(i.widgetId,{action:"fire_app_check"}))})})}function RS(n,e,t,r){const s=t.render(r,{sitekey:e,size:"invisible",callback:()=>{xe(n).reCAPTCHAState.succeeded=!0},"error-callback":()=>{xe(n).reCAPTCHAState.succeeded=!1}}),i=xe(n);i.reCAPTCHAState={...i.reCAPTCHAState,widgetId:s}}function PS(n){const e=document.createElement("script");e.src=AS,e.onload=n,document.head.appendChild(e)}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ll{constructor(e){this._siteKey=e,this._throttleData=null}async getToken(){var r,s,i;xS(this._throttleData);const e=await bS(this._app).catch(o=>{throw tt.create("recaptcha-error")});if(!((r=xe(this._app).reCAPTCHAState)!=null&&r.succeeded))throw tt.create("recaptcha-error");let t;try{t=await al(sS(this._app,e),this._heartbeatServiceProvider)}catch(o){throw(s=o.code)!=null&&s.includes("fetch-status-error")?(this._throttleData=CS(Number((i=o.customData)==null?void 0:i.httpStatus),this._throttleData),tt.create("initial-throttle",{time:hg(this._throttleData.allowRequestsAfter-Date.now()),httpStatus:this._throttleData.httpStatus})):o}return this._throttleData=null,t}initialize(e){this._app=e,this._heartbeatServiceProvider=Xt(e,"heartbeat"),vS(e,this._siteKey).catch(()=>{})}isEqual(e){return e instanceof ll?this._siteKey===e._siteKey:!1}}function CS(n,e){if(n===404||n===403)return{backoffCount:1,allowRequestsAfter:Date.now()+eS,httpStatus:n};{const t=e?e.backoffCount:0,r=Sw(t,1e3,2);return{backoffCount:t+1,allowRequestsAfter:Date.now()+r,httpStatus:n}}}function xS(n){if(n&&Date.now()-n.allowRequestsAfter<=0)throw tt.create("throttled",{time:hg(n.allowRequestsAfter-Date.now()),httpStatus:n.httpStatus})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function DS(n=Ki(),e){n=X(n);const t=Xt(n,"app-check");if(Ga().initialized||fS(),cl()&&ul().then(s=>{}),t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(i.isTokenAutoRefreshEnabled===e.isTokenAutoRefreshEnabled&&i.provider.isEqual(e.provider))return s;throw tt.create("already-initialized",{appName:n.name})}const r=t.initialize({options:e});return kS(n,e.provider,e.isTokenAutoRefreshEnabled),xe(n).isTokenAutoRefreshEnabled&&yg(r,"INTERNAL",()=>{}),r}function kS(n,e,t=!1){const r=Yv(n,{...ug});r.activated=!0,r.provider=e,r.cachedTokenPromise=hS(n).then(s=>(s&&Hr(s)&&(r.token=s,Eg(n,{token:s.token})),s)),r.isTokenAutoRefreshEnabled=t&&n.automaticDataCollectionEnabled,!n.automaticDataCollectionEnabled&&t&&An.warn("`isTokenAutoRefreshEnabled` is true but `automaticDataCollectionEnabled` was set to false during `initializeApp()`. This blocks automatic token refresh."),r.provider.initialize(n)}async function pN(n,e){const t=await da(n,e);if(t.error)throw t.error;if(t.internalError)throw t.internalError;return{token:t.token}}const NS="app-check",yf="app-check-internal";function VS(){Lt(new Tt(NS,n=>{const e=n.getProvider("app").getImmediate(),t=n.getProvider("heartbeat");return IS(e,t)},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((n,e,t)=>{n.getProvider(yf).initialize()})),Lt(new Tt(yf,n=>{const e=n.getProvider("app-check").getImmediate();return ES(e)},"PUBLIC").setInstantiationMode("EXPLICIT")),dt(wS,TS)}VS();var If=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let bs="12.12.0";function OS(n){bs=n}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dn=new Fa("@firebase/firestore");function Gr(){return Dn.logLevel}function MS(n){Dn.setLogLevel(n)}function V(n,...e){if(Dn.logLevel<=te.DEBUG){const t=e.map(hl);Dn.debug(`Firestore (${bs}): ${n}`,...t)}}function ve(n,...e){if(Dn.logLevel<=te.ERROR){const t=e.map(hl);Dn.error(`Firestore (${bs}): ${n}`,...t)}}function ct(n,...e){if(Dn.logLevel<=te.WARN){const t=e.map(hl);Dn.warn(`Firestore (${bs}): ${n}`,...t)}}function hl(n){if(typeof n=="string")return n;try{return function(t){return JSON.stringify(t)}(n)}catch{return n}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function j(n,e,t){let r="Unexpected state";typeof e=="string"?r=e:t=e,Rg(n,r,t)}function Rg(n,e,t){let r=`FIRESTORE (${bs}) INTERNAL ASSERTION FAILED: ${e} (ID: ${n.toString(16)})`;if(t!==void 0)try{r+=" CONTEXT: "+JSON.stringify(t)}catch{r+=" CONTEXT: "+t}throw ve(r),new Error(r)}function q(n,e,t,r){let s="Unexpected state";typeof t=="string"?s=t:r=t,n||Rg(e,s,r)}function LS(n,e){n||j(57014,e)}function L(n,e){return n}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pg{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Cg{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(Me.UNAUTHENTICATED))}shutdown(){}}class FS{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class US{constructor(e){this.t=e,this.currentUser=Me.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){q(this.o===void 0,42304);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new Fe;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new Fe,e.enqueueRetryable(()=>s(this.currentUser))};const o=()=>{const u=i;e.enqueueRetryable(async()=>{await u.promise,await s(this.currentUser)})},c=u=>{V("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(u=>c(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?c(u):(V("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new Fe)}},0),o()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(V("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(q(typeof r.accessToken=="string",31837,{l:r}),new Pg(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return q(e===null||typeof e=="string",2055,{h:e}),new Me(e)}}class BS{constructor(e,t,r){this.P=e,this.T=t,this.I=r,this.type="FirstParty",this.user=Me.FIRST_PARTY,this.R=new Map}A(){return this.I?this.I():null}get headers(){this.R.set("X-Goog-AuthUser",this.P);const e=this.A();return e&&this.R.set("Authorization",e),this.T&&this.R.set("X-Goog-Iam-Authorization-Token",this.T),this.R}}class jS{constructor(e,t,r){this.P=e,this.T=t,this.I=r}getToken(){return Promise.resolve(new BS(this.P,this.T,this.I))}start(e,t){e.enqueueRetryable(()=>t(Me.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class yu{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class GS{constructor(e,t){this.V=t,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,Xe(e)&&e.settings.appCheckToken&&(this.p=e.settings.appCheckToken)}start(e,t){q(this.o===void 0,3512);const r=i=>{i.error!=null&&V("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.m;return this.m=i.token,V("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{V("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?s(i):V("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new yu(this.p));const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(q(typeof t.token=="string",44558,{tokenResult:t}),this.m=t.token,new yu(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}class qS{getToken(){return Promise.resolve(new yu(""))}invalidateToken(){}start(e,t){}shutdown(){}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $S(n){const e=typeof self<"u"&&(self.crypto||self.msCrypto),t=new Uint8Array(n);if(e&&typeof e.getRandomValues=="function")e.getRandomValues(t);else for(let r=0;r<n;r++)t[r]=Math.floor(256*Math.random());return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rr="remoteDocuments",Xi="owner",Mr="owner",Ni="mutationQueues",tb="userId",gt="mutations",bf="batchId",cr="userMutationsIndex",Rf=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ko(n,e){return[n,ze(e)]}function Bg(n,e,t){return[n,ze(e),t]}const nb={},os="documentMutations",pa="remoteDocumentsV14",rb=["prefixPath","collectionGroup","readTime","documentId"],Ho="documentKeyIndex",sb=["prefixPath","collectionGroup","documentId"],jg="collectionGroupIndex",ib=["collectionGroup","readTime","prefixPath","documentId"],Vi="remoteDocumentGlobal",Tu="remoteDocumentGlobalKey",as="targets",Gg="queryTargetsIndex",ob=["canonicalId","targetId"],cs="targetDocuments",ab=["targetId","path"],ml="documentTargetsIndex",cb=["path","targetId"],ma="targetGlobalKey",lr="targetGlobal",Oi="collectionParents",ub=["collectionId","parent"],us="clientMetadata",lb="clientId",Ka="bundles",hb="bundleId",Ha="namedQueries",db="name",gl="indexConfiguration",fb="indexId",Au="collectionGroupIndex",pb="collectionGroup",yi="indexState",mb=["indexId","uid"],qg="sequenceNumberIndex",gb=["uid","sequenceNumber"],Ii="indexEntries",_b=["indexId","uid","arrayValue","directionalValue","orderedDocumentKey","documentKey"],$g="documentKeyIndex",yb=["indexId","uid","orderedDocumentKey"],Wa="documentOverlays",Ib=["userId","collectionPath","documentId"],vu="collectionPathOverlayIndex",Eb=["userId","collectionPath","largestBatchId"],zg="collectionGroupOverlayIndex",wb=["userId","collectionGroup","largestBatchId"],_l="globals",Tb="name",Kg=[Ni,gt,os,rr,as,Xi,lr,cs,us,Vi,Oi,Ka,Ha],Ab=[...Kg,Wa],Hg=[Ni,gt,os,pa,as,Xi,lr,cs,us,Vi,Oi,Ka,Ha,Wa],Wg=Hg,yl=[...Wg,gl,yi,Ii],vb=yl,Qg=[...yl,_l],Sb=Qg;/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Su extends Lg{constructor(e,t){super(),this.le=e,this.currentSequenceNumber=t}}function Ne(n,e){const t=L(n);return Ot.O(t.le,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pb{constructor(e,t,r,s,i,o,c,u,l,d,f){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=s,this.ssl=i,this.forceLongPolling=o,this.autoDetectLongPolling=c,this.longPollingOptions=u,this.useFetchStreams=l,this.isUsingEmulator=d,this.apiKey=f}}const Li="(default)";class kn{constructor(e,t){this.projectId=e,this.database=t||Li}static empty(){return new kn("","")}get isDefaultDatabase(){return this.database===Li}isEqual(e){return e instanceof kn&&e.projectId===this.projectId&&e.database===this.database}}function Cb(n,e){if(!Object.prototype.hasOwnProperty.apply(n.options,["projectId"]))throw new N(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new kn(n.options.projectId,e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Bi{constructor(e,t="asc"){this.field=e,this.dir=t}}function kb(n,e){return n.dir===e.dir&&n.field.isEqual(e.field)}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ub{constructor(e,t=null,r=[],s=[],i=null,o=null,c=null){this.path=e,this.collectionGroup=t,this.orderBy=r,this.filters=s,this.limit=i,this.startAt=o,this.endAt=c,this.Te=null}}function xu(n,e=null,t=[],r=[],s=null,i=null,o=null){return new Ub(n,e,t,r,s,i,o)}function mr(n){const e=L(n);if(e.Te===null){let t=e.path.canonicalString();e.collectionGroup!==null&&(t+="|cg:"+e.collectionGroup),t+="|f:",t+=e.filters.map(r=>Cu(r)).join(","),t+="|ob:",t+=e.orderBy.map(r=>function(i){return i.field.canonicalString()+i.dir}(r)).join(","),Yi(e.limit)||(t+="|l:",t+=e.limit),e.startAt&&(t+="|lb:",t+=e.startAt.inclusive?"b:":"a:",t+=e.startAt.position.map(r=>hs(r)).join(",")),e.endAt&&(t+="|ub:",t+=e.endAt.inclusive?"a:":"b:",t+=e.endAt.position.map(r=>hs(r)).join(",")),e.Te=t}return e.Te}function Zi(n,e){if(n.limit!==e.limit||n.orderBy.length!==e.orderBy.length)return!1;for(let t=0;t<n.orderBy.length;t++)if(!kb(n.orderBy[t],e.orderBy[t]))return!1;if(n.filters.length!==e.filters.length)return!1;for(let t=0;t<n.filters.length;t++)if(!u_(n.filters[t],e.filters[t]))return!1;return n.collectionGroup===e.collectionGroup&&!!n.path.isEqual(e.path)&&!!Lf(n.startAt,e.startAt)&&Lf(n.endAt,e.endAt)}function ga(n){return M.isDocumentKey(n.path)&&n.collectionGroup===null&&n.filters.length===0}function _a(n,e){return n.filters.filter(t=>t instanceof ne&&t.field.isEqual(e))}function Ff(n,e,t){let r=Wo,s=!0;for(const i of _a(n,e)){let o=Wo,c=!0;switch(i.op){case"<":case"<=":o=xb(i.value);break;case"==":case"in":case">=":o=i.value;break;case">":o=i.value,c=!1;break;case"!=":case"not-in":o=Wo}Vf({value:r,inclusive:s},{value:o,inclusive:c})<0&&(r=o,s=c)}if(t!==null){for(let i=0;i<n.orderBy.length;++i)if(n.orderBy[i].field.isEqual(e)){const o=t.position[i];Vf({value:r,inclusive:s},{value:o,inclusive:t.inclusive})<0&&(r=o,s=t.inclusive);break}}return{value:r,inclusive:s}}function Uf(n,e,t){let r=vn,s=!0;for(const i of _a(n,e)){let o=vn,c=!0;switch(i.op){case">=":case">":o=Db(i.value),c=!1;break;case"==":case"in":case"<=":o=i.value;break;case"<":o=i.value,c=!1;break;case"!=":case"not-in":o=vn}Of({value:r,inclusive:s},{value:o,inclusive:c})>0&&(r=o,s=c)}if(t!==null){for(let i=0;i<n.orderBy.length;++i)if(n.orderBy[i].field.isEqual(e)){const o=t.position[i];Of({value:r,inclusive:s},{value:o,inclusive:t.inclusive})>0&&(r=o,s=t.inclusive);break}}return{value:r,inclusive:s}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zb=new he(M.comparator);function st(){return zb}const E_=new he(M.comparator);function di(...n){let e=E_;for(const t of n)e=e.insert(t.key,t);return e}function w_(n){let e=E_;return n.forEach((t,r)=>e=e.insert(t,r.overlayedDocument)),e}function xt(){return wi()}function T_(){return wi()}function wi(){return new nn(n=>n.toString(),(n,e)=>n.isEqual(e))}const Kb=new he(M.comparator),Hb=new ce(M.comparator);function J(...n){let e=Hb;for(const t of n)e=e.add(t);return e}const Wb=new ce(H);function Al(){return Wb}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xa{constructor(){this._=void 0}}function Qb(n,e,t){return n instanceof fs?function(s,i){const o={fields:{[e_]:{stringValue:Zg},[n_]:{timestampValue:{seconds:s.seconds,nanos:s.nanoseconds}}}};return i&&Qa(i)&&(i=Ja(i)),i&&(o.fields[t_]=i),{mapValue:o}}(t,e):n instanceof gr?b_(n,e):n instanceof _r?R_(n,e):function(s,i){const o=S_(s,i),c=jf(o)+jf(s.Ae);return Ru(o)&&Ru(s.Ae)?A_(c):vl(s.serializer,c)}(n,e)}function Jb(n,e,t){return n instanceof gr?b_(n,e):n instanceof _r?R_(n,e):t}function S_(n,e){return n instanceof ps?function(r){return Ru(r)||function(i){return!!i&&"doubleValue"in i}(r)}(e)?e:{integerValue:0}:null}class fs extends Xa{}class gr extends Xa{constructor(e){super(),this.elements=e}}function b_(n,e){const t=P_(e);for(const r of n.elements)t.some(s=>Ft(s,r))||t.push(r);return{arrayValue:{values:t}}}class _r extends Xa{constructor(e){super(),this.elements=e}}function R_(n,e){let t=P_(e);for(const r of n.elements)t=t.filter(s=>!Ft(s,r));return{arrayValue:{values:t}}}class ps extends Xa{constructor(e,t){super(),this.serializer=e,this.Ae=t}}function jf(n){return me(n.integerValue||n.doubleValue)}function P_(n){return Ui(n)&&n.arrayValue.values?n.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var be,se;function k_(n){switch(n){case P.OK:return j(64938);case P.CANCELLED:case P.UNKNOWN:case P.DEADLINE_EXCEEDED:case P.RESOURCE_EXHAUSTED:case P.INTERNAL:case P.UNAVAILABLE:case P.UNAUTHENTICATED:return!1;case P.INVALID_ARGUMENT:case P.NOT_FOUND:case P.ALREADY_EXISTS:case P.PERMISSION_DENIED:case P.FAILED_PRECONDITION:case P.ABORTED:case P.OUT_OF_RANGE:case P.UNIMPLEMENTED:case P.DATA_LOSS:return!0;default:return j(15467,{code:n})}}function N_(n){if(n===void 0)return ve("GRPC error has no .code"),P.UNKNOWN;switch(n){case be.OK:return P.OK;case be.CANCELLED:return P.CANCELLED;case be.UNKNOWN:return P.UNKNOWN;case be.DEADLINE_EXCEEDED:return P.DEADLINE_EXCEEDED;case be.RESOURCE_EXHAUSTED:return P.RESOURCE_EXHAUSTED;case be.INTERNAL:return P.INTERNAL;case be.UNAVAILABLE:return P.UNAVAILABLE;case be.UNAUTHENTICATED:return P.UNAUTHENTICATED;case be.INVALID_ARGUMENT:return P.INVALID_ARGUMENT;case be.NOT_FOUND:return P.NOT_FOUND;case be.ALREADY_EXISTS:return P.ALREADY_EXISTS;case be.PERMISSION_DENIED:return P.PERMISSION_DENIED;case be.FAILED_PRECONDITION:return P.FAILED_PRECONDITION;case be.ABORTED:return P.ABORTED;case be.OUT_OF_RANGE:return P.OUT_OF_RANGE;case be.UNIMPLEMENTED:return P.UNIMPLEMENTED;case be.DATA_LOSS:return P.DATA_LOSS;default:return j(39323,{code:n})}}(se=be||(be={}))[se.OK=0]="OK",se[se.CANCELLED=1]="CANCELLED",se[se.UNKNOWN=2]="UNKNOWN",se[se.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",se[se.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",se[se.NOT_FOUND=5]="NOT_FOUND",se[se.ALREADY_EXISTS=6]="ALREADY_EXISTS",se[se.PERMISSION_DENIED=7]="PERMISSION_DENIED",se[se.UNAUTHENTICATED=16]="UNAUTHENTICATED",se[se.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",se[se.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",se[se.ABORTED=10]="ABORTED",se[se.OUT_OF_RANGE=11]="OUT_OF_RANGE",se[se.UNIMPLEMENTED=12]="UNIMPLEMENTED",se[se.INTERNAL=13]="INTERNAL",se[se.UNAVAILABLE=14]="UNAVAILABLE",se[se.DATA_LOSS=15]="DATA_LOSS";/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bR{constructor(){this.bn=new kl}addToCollectionParentIndex(e,t){return this.bn.add(t),S.resolve()}getCollectionParents(e,t){return S.resolve(this.bn.getEntries(t))}addFieldIndex(e,t){return S.resolve()}deleteFieldIndex(e,t){return S.resolve()}deleteAllFieldIndexes(e){return S.resolve()}createTargetIndexes(e,t){return S.resolve()}getDocumentsMatchingTarget(e,t){return S.resolve(null)}getIndexType(e,t){return S.resolve(0)}getFieldIndexes(e,t){return S.resolve([])}getNextCollectionGroupToUpdate(e){return S.resolve(null)}getMinOffset(e,t){return S.resolve(pt.min())}getMinOffsetFromCollectionGroup(e,t){return S.resolve(pt.min())}updateCollectionGroup(e,t,r){return S.resolve()}updateIndexEntries(e,t){return S.resolve()}}class kl{constructor(){this.index={}}add(e){const t=e.lastSegment(),r=e.popLast(),s=this.index[t]||new ce(Z.comparator),i=!s.has(r);return this.index[t]=s.add(r),i}has(e){const t=e.lastSegment(),r=e.popLast(),s=this.index[t];return s&&s.has(r)}getEntries(e){return(this.index[e]||new ce(Z.comparator)).toArray()}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const op="IndexedDbIndexManager",Vo=new Uint8Array(0);class RR{constructor(e,t){this.databaseId=t,this.Dn=new kl,this.Cn=new nn(r=>mr(r),(r,s)=>Zi(r,s)),this.uid=e.uid||""}addToCollectionParentIndex(e,t){if(!this.Dn.has(t)){const r=t.lastSegment(),s=t.popLast();e.addOnCommittedListener(()=>{this.Dn.add(t)});const i={collectionId:r,parent:ze(s)};return ap(e).put(i)}return S.resolve()}getCollectionParents(e,t){const r=[],s=IDBKeyRange.bound([t,""],[xg(t),""],!1,!0);return ap(e).J(s).next(i=>{for(const o of i){if(o.collectionId!==t)break;r.push(Ct(o.parent))}return r})}addFieldIndex(e,t){const r=si(e),s=function(c){return{indexId:c.indexId,collectionGroup:c.collectionGroup,fields:c.fields.map(u=>[u.fieldPath.canonicalString(),u.kind])}}(t);delete s.indexId;const i=r.add(s);if(t.indexState){const o=Br(e);return i.next(c=>{o.put(Xf(c,this.uid,t.indexState.sequenceNumber,t.indexState.offset))})}return i.next()}deleteFieldIndex(e,t){const r=si(e),s=Br(e),i=Ur(e);return r.delete(t.indexId).next(()=>s.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0))).next(()=>i.delete(IDBKeyRange.bound([t.indexId],[t.indexId+1],!1,!0)))}deleteAllFieldIndexes(e){const t=si(e),r=Ur(e),s=Br(e);return t.X().next(()=>r.X()).next(()=>s.X())}createTargetIndexes(e,t){return S.forEach(this.vn(t),r=>this.getIndexType(e,r).next(s=>{if(s===0||s===1){const i=new sp(r).Sn();if(i!=null)return this.addFieldIndex(e,i)}}))}getDocumentsMatchingTarget(e,t){const r=Ur(e);let s=!0;const i=new Map;return S.forEach(this.vn(t),o=>this.Fn(e,o).next(c=>{s&&(s=!!c),i.set(o,c)})).next(()=>{if(s){let o=J();const c=[];return S.forEach(i,(u,l)=>{V(op,`Using index ${function(B){return`id=${B.indexId}|cg=${B.collectionGroup}|f=${B.fields.map(z=>`${z.fieldPath}:${z.kind}`).join(",")}`}(u)} to execute ${mr(t)}`);const d=function(B,z){const W=wu(z);if(W===void 0)return null;for(const Q of _a(B,W.fieldPath))switch(Q.op){case"array-contains-any":return Q.value.arrayValue.values||[];case"array-contains":return[Q.value]}return null}(l,u),f=function(B,z){const W=new Map;for(const Q of nr(z))for(const E of _a(B,Q.fieldPath))switch(E.op){case"==":case"in":W.set(Q.fieldPath.canonicalString(),E.value);break;case"not-in":case"!=":return W.set(Q.fieldPath.canonicalString(),E.value),Array.from(W.values())}return null}(l,u),m=function(B,z){const W=[];let Q=!0;for(const E of nr(z)){const I=E.kind===0?Ff(B,E.fieldPath,B.startAt):Uf(B,E.fieldPath,B.startAt);W.push(I.value),Q&&(Q=I.inclusive)}return new On(W,Q)}(l,u),y=function(B,z){const W=[];let Q=!0;for(const E of nr(z)){const I=E.kind===0?Uf(B,E.fieldPath,B.endAt):Ff(B,E.fieldPath,B.endAt);W.push(I.value),Q&&(Q=I.inclusive)}return new On(W,Q)}(l,u),b=this.Mn(u,l,m),x=this.Mn(u,l,y),k=this.xn(u,l,f),O=this.On(u.indexId,d,b,m.inclusive,x,y.inclusive,k);return S.forEach(O,U=>r.Z(U,t.limit).next(B=>{B.forEach(z=>{const W=M.fromSegments(z.documentKey);o.has(W)||(o=o.add(W),c.push(W))})}))}).next(()=>c)}return S.resolve(null)})}vn(e){let t=this.Cn.get(e);return t||(e.filters.length===0?t=[e]:t=SR(oe.create(e.filters,"and")).map(r=>xu(e.path,e.collectionGroup,e.orderBy,r.getFilters(),e.limit,e.startAt,e.endAt)),this.Cn.set(e,t),t)}On(e,t,r,s,i,o,c){const u=(t!=null?t.length:1)*Math.max(r.length,i.length),l=u/(t!=null?t.length:1),d=[];for(let f=0;f<u;++f){const m=t?this.Nn(t[f/l]):Vo,y=this.Bn(e,m,r[f%l],s),b=this.Ln(e,m,i[f%l],o),x=c.map(k=>this.Bn(e,m,k,!0));d.push(...this.createRange(y,b,x))}return d}Bn(e,t,r,s){const i=new ar(e,M.empty(),t,r);return s?i:i.In()}Ln(e,t,r,s){const i=new ar(e,M.empty(),t,r);return s?i.In():i}Fn(e,t){const r=new sp(t),s=t.collectionGroup!=null?t.collectionGroup:t.path.lastSegment();return this.getFieldIndexes(e,s).next(i=>{let o=null;for(const c of i)r.gn(c)&&(!o||c.fields.length>o.fields.length)&&(o=c);return o})}getIndexType(e,t){let r=2;const s=this.vn(t);return S.forEach(s,i=>this.Fn(e,i).next(o=>{o?r!==0&&o.fields.length<function(u){let l=new ce(pe.comparator),d=!1;for(const f of u.filters)for(const m of f.getFlattenedFilters())m.field.isKeyField()||(m.op==="array-contains"||m.op==="array-contains-any"?d=!0:l=l.add(m.field));for(const f of u.orderBy)f.field.isKeyField()||(l=l.add(f.field));return l.size+(d?1:0)}(i)&&(r=1):r=0})).next(()=>function(o){return o.limit!==null}(t)&&s.length>1&&r===2?1:r)}kn(e,t){const r=new ri;for(const s of nr(e)){const i=t.data.field(s.fieldPath);if(i==null)return null;const o=r.ln(s.kind);or.Wt.Dt(i,o)}return r.un()}Nn(e){const t=new ri;return or.Wt.Dt(e,t.ln(0)),t.un()}qn(e,t){const r=new ri;return or.Wt.Dt(pr(this.databaseId,t),r.ln(function(i){const o=nr(i);return o.length===0?0:o[o.length-1].kind}(e))),r.un()}xn(e,t,r){if(r===null)return[];let s=[];s.push(new ri);let i=0;for(const o of nr(e)){const c=r[i++];for(const u of s)if(this.Kn(t,o.fieldPath)&&Ui(c))s=this.Un(s,o,c);else{const l=u.ln(o.kind);or.Wt.Dt(c,l)}}return this.$n(s)}Mn(e,t,r){return this.xn(e,t,r.position)}$n(e){const t=[];for(let r=0;r<e.length;++r)t[r]=e[r].un();return t}Un(e,t,r){const s=[...e],i=[];for(const o of r.arrayValue.values||[])for(const c of s){const u=new ri;u.seed(c.un()),or.Wt.Dt(o,u.ln(t.kind)),i.push(u)}return i}Kn(e,t){return!!e.filters.find(r=>r instanceof ne&&r.field.isEqual(t)&&(r.op==="in"||r.op==="not-in"))}getFieldIndexes(e,t){const r=si(e),s=Br(e);return(t?r.J(Au,IDBKeyRange.bound(t,t)):r.J()).next(i=>{const o=[];return S.forEach(i,c=>s.get([c.indexId,this.uid]).next(u=>{o.push(function(d,f){const m=f?new is(f.sequenceNumber,new pt(Ir(f.readTime),new M(Ct(f.documentKey)),f.largestBatchId)):is.empty(),y=d.fields.map(([b,x])=>new ur(pe.fromServerFormat(b),x));return new ss(d.indexId,d.collectionGroup,y,m)}(c,u))})).next(()=>o)})}getNextCollectionGroupToUpdate(e){return this.getFieldIndexes(e).next(t=>t.length===0?null:(t.sort((r,s)=>{const i=r.indexState.sequenceNumber-s.indexState.sequenceNumber;return i!==0?i:H(r.collectionGroup,s.collectionGroup)}),t[0].collectionGroup))}updateCollectionGroup(e,t,r){const s=si(e),i=Br(e);return this.Wn(e).next(o=>s.J(Au,IDBKeyRange.bound(t,t)).next(c=>S.forEach(c,u=>i.put(Xf(u.indexId,this.uid,o,r)))))}updateIndexEntries(e,t){const r=new Map;return S.forEach(t,(s,i)=>{const o=r.get(s.collectionGroup);return(o?S.resolve(o):this.getFieldIndexes(e,s.collectionGroup)).next(c=>(r.set(s.collectionGroup,c),S.forEach(c,u=>this.Qn(e,s,u).next(l=>{const d=this.Gn(i,u);return l.isEqual(d)?S.resolve():this.zn(e,i,u,l,d)}))))})}jn(e,t,r,s){return Ur(e).put(s.Rn(this.uid,this.qn(r,t.key),t.key))}Jn(e,t,r,s){return Ur(e).delete(s.An(this.uid,this.qn(r,t.key),t.key))}Qn(e,t,r){const s=Ur(e);let i=new ce(fn);return s.ee({index:$g,range:IDBKeyRange.only([r.indexId,this.uid,Zo(this.qn(r,t))])},(o,c)=>{i=i.add(new ar(r.indexId,t,rp(c.arrayValue),rp(c.directionalValue)))}).next(()=>i)}Gn(e,t){let r=new ce(fn);const s=this.kn(t,e);if(s==null)return r;const i=wu(t);if(i!=null){const o=e.data.field(i.fieldPath);if(Ui(o))for(const c of o.arrayValue.values||[])r=r.add(new ar(t.indexId,e.key,this.Nn(c),s))}else r=r.add(new ar(t.indexId,e.key,Vo,s));return r}zn(e,t,r,s,i){V(op,"Updating index entries for document '%s'",t.key);const o=[];return function(u,l,d,f,m){const y=u.getIterator(),b=l.getIterator();let x=Lr(y),k=Lr(b);for(;x||k;){let O=!1,U=!1;if(x&&k){const B=d(x,k);B<0?U=!0:B>0&&(O=!0)}else x!=null?U=!0:O=!0;O?(f(k),k=Lr(b)):U?(m(x),x=Lr(y)):(x=Lr(y),k=Lr(b))}}(s,i,fn,c=>{o.push(this.jn(e,t,r,c))},c=>{o.push(this.Jn(e,t,r,c))}),S.waitFor(o)}Wn(e){let t=1;return Br(e).ee({index:qg,reverse:!0,range:IDBKeyRange.upperBound([this.uid,Number.MAX_SAFE_INTEGER])},(r,s,i)=>{i.done(),t=s.sequenceNumber+1}).next(()=>t)}createRange(e,t,r){r=r.sort((o,c)=>fn(o,c)).filter((o,c,u)=>!c||fn(o,u[c-1])!==0);const s=[];s.push(e);for(const o of r){const c=fn(o,e),u=fn(o,t);if(c===0)s[0]=e.In();else if(c>0&&u<0)s.push(o),s.push(o.In());else if(u>0)break}s.push(t);const i=[];for(let o=0;o<s.length;o+=2){if(this.Hn(s[o],s[o+1]))return[];const c=s[o].An(this.uid,Vo,M.empty()),u=s[o+1].An(this.uid,Vo,M.empty());i.push(IDBKeyRange.bound(c,u))}return i}Hn(e,t){return fn(e,t)>0}getMinOffsetFromCollectionGroup(e,t){return this.getFieldIndexes(e,t).next(cp)}getMinOffset(e,t){return S.mapArray(this.vn(t),r=>this.Fn(e,r).next(s=>s||j(44426))).next(cp)}}function ap(n){return Ne(n,Oi)}function Ur(n){return Ne(n,Ii)}function si(n){return Ne(n,gl)}function Br(n){return Ne(n,yi)}function cp(n){q(n.length!==0,28825);let e=n[0].indexState.offset,t=e.largestBatchId;for(let r=1;r<n.length;r++){const s=n[r].indexState.offset;fl(s,e)<0&&(e=s),t<s.largestBatchId&&(t=s.largestBatchId)}return new pt(e.readTime,e.documentKey,t)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ey(n,e,t){const r=n.store(gt),s=n.store(os),i=[],o=IDBKeyRange.only(t.batchId);let c=0;const u=r.ee({range:o},(d,f,m)=>(c++,m.delete()));i.push(u.next(()=>{q(c===1,47070,{batchId:t.batchId})}));const l=[];for(const d of t.mutations){const f=Bg(e,d.key.path,t.batchId);i.push(s.delete(f)),l.push(d.key)}return S.waitFor(i).next(()=>l)}function wa(n){if(!n)return 0;let e;if(n.document)e=n.document;else if(n.unknownDocument)e=n.unknownDocument;else{if(!n.noDocument)throw j(14731);e=n.noDocument}return JSON.stringify(e).length}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oy{constructor(){this.changes=new nn(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,fe.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?S.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class OR{constructor(e){this.serializer=e,this.Nr=new Map,this.Br=new Map}getBundleMetadata(e,t){return S.resolve(this.Nr.get(t))}saveBundleMetadata(e,t){return this.Nr.set(t.id,function(s){return{id:s.id,version:s.version,createTime:Se(s.createTime)}}(t)),S.resolve()}getNamedQuery(e,t){return S.resolve(this.Br.get(t))}saveNamedQuery(e,t){return this.Br.set(t.name,function(s){return{name:s.name,query:nc(s.bundledQuery),readTime:Se(s.readTime)}}(t)),S.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class MR{constructor(){this.overlays=new he(M.comparator),this.Lr=new Map}getOverlay(e,t){return S.resolve(this.overlays.get(t))}getOverlays(e,t){const r=xt();return S.forEach(t,s=>this.getOverlay(e,s).next(i=>{i!==null&&r.set(s,i)})).next(()=>r)}saveOverlays(e,t,r){return r.forEach((s,i)=>{this.St(e,t,i)}),S.resolve()}removeOverlaysForBatchId(e,t,r){const s=this.Lr.get(r);return s!==void 0&&(s.forEach(i=>this.overlays=this.overlays.remove(i)),this.Lr.delete(r)),S.resolve()}getOverlaysForCollection(e,t,r){const s=xt(),i=t.length+1,o=new M(t.child("")),c=this.overlays.getIteratorFrom(o);for(;c.hasNext();){const u=c.getNext().value,l=u.getKey();if(!t.isPrefixOf(l.path))break;l.path.length===i&&u.largestBatchId>r&&s.set(u.getKey(),u)}return S.resolve(s)}getOverlaysForCollectionGroup(e,t,r,s){let i=new he((l,d)=>l-d);const o=this.overlays.getIterator();for(;o.hasNext();){const l=o.getNext().value;if(l.getKey().getCollectionGroup()===t&&l.largestBatchId>r){let d=i.get(l.largestBatchId);d===null&&(d=xt(),i=i.insert(l.largestBatchId,d)),d.set(l.getKey(),l)}}const c=xt(),u=i.getIterator();for(;u.hasNext()&&(u.getNext().value.forEach((l,d)=>c.set(l,d)),!(c.size()>=s)););return S.resolve(c)}St(e,t,r){const s=this.overlays.get(r.key);if(s!==null){const o=this.Lr.get(s.largestBatchId).delete(r.key);this.Lr.set(s.largestBatchId,o)}this.overlays=this.overlays.insert(r.key,new Pl(t,r));let i=this.Lr.get(t);i===void 0&&(i=J(),this.Lr.set(t,i)),this.Lr.set(t,i.add(r.key))}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class LR{constructor(){this.sessionToken=Ie.EMPTY_BYTE_STRING}getSessionToken(e){return S.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,S.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class FR{constructor(e,t){this.indexManager=e,this.referenceDelegate=t,this.mutationQueue=[],this.Yn=1,this.Hr=new ce(Oe.qr)}checkEmpty(e){return S.resolve(this.mutationQueue.length===0)}addMutationBatch(e,t,r,s){const i=this.Yn;this.Yn++,this.mutationQueue.length>0&&this.mutationQueue[this.mutationQueue.length-1];const o=new bl(i,t,r,s);this.mutationQueue.push(o);for(const c of s)this.Hr=this.Hr.add(new Oe(c.key,i)),this.indexManager.addToCollectionParentIndex(e,c.key.path.popLast());return S.resolve(o)}lookupMutationBatch(e,t){return S.resolve(this.Zr(t))}getNextMutationBatchAfterBatchId(e,t){const r=t+1,s=this.Xr(r),i=s<0?0:s;return S.resolve(this.mutationQueue.length>i?this.mutationQueue[i]:null)}getHighestUnacknowledgedBatchId(){return S.resolve(this.mutationQueue.length===0?Cn:this.Yn-1)}getAllMutationBatches(e){return S.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){const r=new Oe(t,0),s=new Oe(t,Number.POSITIVE_INFINITY),i=[];return this.Hr.forEachInRange([r,s],o=>{const c=this.Zr(o.Jr);i.push(c)}),S.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let r=new ce(H);return t.forEach(s=>{const i=new Oe(s,0),o=new Oe(s,Number.POSITIVE_INFINITY);this.Hr.forEachInRange([i,o],c=>{r=r.add(c.Jr)})}),S.resolve(this.Yr(r))}getAllMutationBatchesAffectingQuery(e,t){const r=t.path,s=r.length+1;let i=r;M.isDocumentKey(i)||(i=i.child(""));const o=new Oe(new M(i),0);let c=new ce(H);return this.Hr.forEachWhile(u=>{const l=u.key.path;return!!r.isPrefixOf(l)&&(l.length===s&&(c=c.add(u.Jr)),!0)},o),S.resolve(this.Yr(c))}Yr(e){const t=[];return e.forEach(r=>{const s=this.Zr(r);s!==null&&t.push(s)}),t}removeMutationBatch(e,t){q(this.ei(t.batchId,"removed")===0,55003),this.mutationQueue.shift();let r=this.Hr;return S.forEach(t.mutations,s=>{const i=new Oe(s.key,t.batchId);return r=r.delete(i),this.referenceDelegate.markPotentiallyOrphaned(e,s.key)}).next(()=>{this.Hr=r})}nr(e){}containsKey(e,t){const r=new Oe(t,0),s=this.Hr.firstAfterOrEqual(r);return S.resolve(t.isEqual(s&&s.key))}performConsistencyCheck(e){return this.mutationQueue.length,S.resolve()}ei(e,t){return this.Xr(e)}Xr(e){return this.mutationQueue.length===0?0:e-this.mutationQueue[0].batchId}Zr(e){const t=this.Xr(e);return t<0||t>=this.mutationQueue.length?null:this.mutationQueue[t]}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function br(n){return new cR(n,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d0="ComponentProvider",Dp=new Map;function f0(n,e,t,r,s){return new Pb(n,e,t,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,zy(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,r)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class It{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new N(P.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new N(P.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}_compareTo(e){return H(this._lat,e._lat)||H(this._long,e._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:It._jsonSchemaVersion}}static fromJSON(e){if(Sr(e,It._jsonSchema))return new It(e.latitude,e.longitude)}}It._jsonSchemaVersion="firestore/geoPoint/1.0",It._jsonSchema={type:Re("string",It._jsonSchemaVersion),latitude:Re("number"),longitude:Re("number")};/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fC{constructor(e,t){this._firestore=e,this._transaction=t,this._dataReader=Pr(e)}get(e){const t=Sn(e,this._firestore),r=new gh(this._firestore);return this._transaction.lookup([t._key]).then(s=>{if(!s||s.length!==1)return j(24041);const i=s[0];if(i.isFoundDocument())return new qi(this._firestore,r,i.key,i,t.converter);if(i.isNoDocument())return new qi(this._firestore,r,t._key,null,t.converter);throw j(18433,{doc:i})})}set(e,t,r){const s=Sn(e,this._firestore),i=fc(s.converter,t,r),o=hc(this._dataReader,"Transaction.set",s._key,i,s.converter!==null,r);return this._transaction.set(s._key,o),this}update(e,t,r,...s){const i=Sn(e,this._firestore);let o;return o=typeof(t=X(t))=="string"||t instanceof Rr?hh(this._dataReader,"Transaction.update",i._key,t,r,s):lh(this._dataReader,"Transaction.update",i._key,t),this._transaction.update(i._key,o),this}delete(e){const t=Sn(e,this._firestore);return this._transaction.delete(t._key),this}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class RC{constructor(){throw new Error("instances of this class should not be created")}static onExistenceFilterMismatch(e){return Ih.instance.onExistenceFilterMismatch(e)}}class Ih{constructor(){this.t=new Map}static get instance(){return Fo||(Fo=new Ih,nR(Fo)),Fo}o(e){this.t.forEach(t=>t(e))}onExistenceFilterMismatch(e){const t=Symbol(),r=this.t;return r.set(t,e),()=>r.delete(t)}}let Fo=null;(function(e,t=!0){OS(vr),Lt(new Tt("firestore",(r,{instanceIdentifier:s,options:i})=>{const o=r.getProvider("app").getImmediate(),c=new ue(new US(r.getProvider("auth-internal")),new GS(o,r.getProvider("app-check-internal")),Cb(o,s),o);return i={useFetchStreams:t,...i},c._setSettings(i),c},"PUBLIC").setMultipleInstances(!0)),dt(Lp,Fp,e),dt(Lp,Fp,"esm2020")})();const Eh=Object.freeze(Object.defineProperty({__proto__:null,AbstractUserDataWriter:ph,AggregateField:Ts,AggregateQuerySnapshot:aI,Bytes:et,CACHE_SIZE_UNLIMITED:g0,CollectionReference:yt,DocumentReference:ae,DocumentSnapshot:ot,FieldPath:Rr,FieldValue:zn,Firestore:ue,FirestoreError:N,GeoPoint:It,LoadBundleTask:Wy,PersistentCacheIndexManager:yI,Query:ke,QueryCompositeFilterConstraint:xr,QueryConstraint:Os,QueryDocumentSnapshot:Si,QueryEndAtConstraint:lo,QueryFieldFilterConstraint:Ms,QueryLimitConstraint:co,QueryOrderByConstraint:dc,QuerySnapshot:at,QueryStartAtConstraint:uo,SnapshotMetadata:$t,Timestamp:ie,Transaction:_I,VectorValue:ft,WriteBatch:gI,_AutoId:qa,_ByteString:Ie,_DatabaseId:kn,_DocumentKey:M,_EmptyAppCheckTokenProvider:qS,_EmptyAuthCredentialsProvider:Cg,_FieldPath:pe,_TestingHooks:RC,_cast:ee,_debugAssert:LS,_internalAggregationQueryToProtoRunAggregationQueryRequest:O0,_internalQueryToProtoQueryTarget:V0,_isBase64Available:bb,_logWarn:ct,_validateIsNotUsedTogether:Dg,addDoc:_h,aggregateFieldEqual:W0,aggregateQuerySnapshotEqual:Q0,and:U0,arrayRemove:D0,arrayUnion:x0,average:H0,clearIndexedDbPersistence:I0,collection:mt,collectionGroup:p0,connectFirestoreEmulator:Hy,count:dI,deleteAllPersistentCacheIndexes:bC,deleteDoc:pc,deleteField:C0,disableNetwork:T0,disablePersistentCacheIndexAutoCreation:SC,doc:we,documentId:v0,documentSnapshotFromJSON:cC,enableIndexedDbPersistence:y0,enableMultiTabIndexedDbPersistence:Yy,enableNetwork:w0,enablePersistentCacheIndexAutoCreation:vC,endAt:z0,endBefore:$0,ensureFirestoreConfigured:ye,executeWrite:Ls,getAggregateFromServer:fI,getCountFromServer:J0,getDoc:kr,getDocFromCache:mC,getDocFromServer:gC,getDocs:Pa,getDocsFromCache:_C,getDocsFromServer:yC,getFirestore:Qy,getPersistentCacheIndexManager:AC,increment:k0,initializeFirestore:_0,limit:B0,limitToLast:j0,loadBundle:$u,memoryEagerGarbageCollector:tC,memoryLocalCache:rC,memoryLruGarbageCollector:nC,namedQuery:Zy,onSnapshot:Yt,onSnapshotResume:IC,onSnapshotsInSync:EC,or:F0,orderBy:Dr,persistentLocalCache:sC,persistentMultipleTabManager:aC,persistentSingleTabManager:pI,query:Hn,queryEqual:ih,querySnapshotFromJSON:uC,refEqual:m0,runTransaction:pC,serverTimestamp:xn,setDoc:Et,setIndexConfiguration:TC,setLogLevel:MS,snapshotEqual:hC,startAfter:q0,startAt:G0,sum:K0,terminate:A0,updateDoc:Un,vector:N0,waitForPendingWrites:E0,where:L0,writeBatch:wC},Symbol.toStringTag,{value:"Module"}));/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function zC(n,e,t){let r=1,s=null,i=null,o=!1,c=0;function u(){return c===2}let l=!1;function d(...k){l||(l=!0,e.apply(null,k))}function f(k){s=setTimeout(()=>{s=null,n(y,u())},k)}function m(){i&&clearTimeout(i)}function y(k,...O){if(l){m();return}if(k){m(),d.call(null,k,...O);return}if(u()||o){m(),d.call(null,k,...O);return}r<64&&(r*=2);let B;c===1?(c=2,B=0):B=(r+Math.random())*1e3,f(B)}let b=!1;function x(k){b||(b=!0,m(),!l&&(s!==null?(k||(c=2),clearTimeout(s),f(0)):k||(c=1)))}return f(0),i=setTimeout(()=>{o=!0,x(!0)},t),x}function KC(n){n(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dt={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class iu{constructor(e,t){this.data=e,this.contentType=t||null}}function ox(n,e){switch(n){case Dt.RAW:return new iu(vI(e));case Dt.BASE64:case Dt.BASE64URL:return new iu(SI(n,e));case Dt.DATA_URL:return new iu(cx(e),ux(e))}throw wh()}function vI(n){const e=[];for(let t=0;t<n.length;t++){let r=n.charCodeAt(t);if(r<=127)e.push(r);else if(r<=2047)e.push(192|r>>6,128|r&63);else if((r&64512)===55296)if(!(t<n.length-1&&(n.charCodeAt(t+1)&64512)===56320))e.push(239,191,189);else{const i=r,o=n.charCodeAt(++t);r=65536|(i&1023)<<10|o&1023,e.push(240|r>>18,128|r>>12&63,128|r>>6&63,128|r&63)}else(r&64512)===56320?e.push(239,191,189):e.push(224|r>>12,128|r>>6&63,128|r&63)}return new Uint8Array(e)}function ax(n){let e;try{e=decodeURIComponent(n)}catch{throw bi(Dt.DATA_URL,"Malformed data URL.")}return vI(e)}function SI(n,e){switch(n){case Dt.BASE64:{const s=e.indexOf("-")!==-1,i=e.indexOf("_")!==-1;if(s||i)throw bi(n,"Invalid character '"+(s?"-":"_")+"' found: is it base64url encoded?");break}case Dt.BASE64URL:{const s=e.indexOf("+")!==-1,i=e.indexOf("/")!==-1;if(s||i)throw bi(n,"Invalid character '"+(s?"+":"/")+"' found: is it base64 encoded?");e=e.replace(/-/g,"+").replace(/_/g,"/");break}}let t;try{t=ix(e)}catch(s){throw s.message.includes("polyfill")?s:bi(n,"Invalid character found")}const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r}class bI{constructor(e){this.base64=!1,this.contentType=null;const t=e.match(/^data:([^,]+)?,/);if(t===null)throw bi(Dt.DATA_URL,"Must be formatted 'data:[<mediatype>][;base64],<data>");const r=t[1]||null;r!=null&&(this.base64=lx(r,";base64"),this.contentType=this.base64?r.substring(0,r.length-7):r),this.rest=e.substring(e.indexOf(",")+1)}}function cx(n){const e=new bI(n);return e.base64?SI(Dt.BASE64,e.rest):ax(e.rest)}function ux(n){return new bI(n).contentType}function lx(n,e){return n.length>=e.length?n.substring(n.length-e.length)===e:!1}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ar{constructor(e,t){this._service=e,t instanceof ht?this._location=t:this._location=ht.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Ar(e,t)}get root(){const e=new ht(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return PI(this._location.path)}get storage(){return this._service}get parent(){const e=hx(this._location.path);if(e===null)return null;const t=new ht(this._location.bucket,e);return new Ar(this._service,t)}_throwIfRoot(e){if(this._location.path==="")throw qC(e)}}function Px(n,e,t){n._throwIfRoot("uploadBytes");const r=Sx(n.storage,n._location,CI(),new Tn(e,!0),t);return n.storage.makeRequestWithTokens(r,Sh).then(s=>({metadata:s,ref:n}))}function Cx(n){n._throwIfRoot("getDownloadURL");const e=wx(n.storage,n._location,CI());return n.storage.makeRequestWithTokens(e,Sh).then(t=>{if(t===null)throw jC();return t})}function xx(n){n._throwIfRoot("deleteObject");const e=Tx(n.storage,n._location);return n.storage.makeRequestWithTokens(e,Sh)}function Dx(n,e){const t=dx(n._location.path,e),r=new ht(n._location.bucket,t);return new Ar(n.storage,r)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
